...
{
    [TestFixture]
    public class TokenIndirectParenthesisReplacementTests : TokenReplacementTest
    {
        protected override ITokenReplacement Replacer => new TokenIndirectParenthesisReplacement();
